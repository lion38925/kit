...
// this solution is backtracking complexity
...
//-----------------below this code there is bfs solution of O(V+E) complexity
...
//The approach here is to color each node from 1 to n initially by color 1.
//And start travelling BFS from an unvisited starting node to cover all
//connected components in one go. On reaching each node during BFS traversal, do the following:
