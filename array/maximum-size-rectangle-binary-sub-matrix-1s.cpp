...
//---- in this the histogram is caluculated using different way watch pepcoding histogram way to solve it in better and easy way

// https://www.youtube.com/watch?v=0do2734xhnU&ab_channel=Pepcoding
int maxHist(int row[])
{
